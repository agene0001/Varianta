                                            ...
                                            variations: [
                                              ...
                                              },
                                              {
                                                ...
                                                variations: line(
                                                  ...
                                                  { san: "d4", description: "Black played Nf6. Now take the centre with d4 while your knight holds d5. The e4 pawn really is hanging — Nc3 left the square when it jumped to d5 — but taking it costs Black: 9...Nxe4 10.Qd3! and the knight has no defender, so Black must spend a move propping it up. 10...f5 is the best try (about +1.9 for White) but it wrecks the kingside; 10...Nf6 11.Qc4! hits f7 and the king never gets castled (+3.5). Retreating instead just drops the piece: ...Nc5 to dxc5, ...Ng3 to hxg3, ...Nd2 to Bxd2, ...Nc3 to bxc3." },
