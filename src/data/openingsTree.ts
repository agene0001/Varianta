                                        ...
                                        variations: [
                                          {
                                            ...
                                            variations: [
                                              ...
                                              },
                                              {
                                                ...
                                                lineDescription: "Trade on your terms with Bd5, recapture with the e-pawn, and Black is left with a permanently weak d5 square.",
                                                variations: line(
                                                  ...
                                                  { san: "exd5", description: "Black played Bxd5. Recapture with the e-pawn! It gains a tempo on the c6 knight and leaves you a protected passed pawn in the centre." },
                                                  { san: "Nce7", description: "Black's knight retreats to e7, kicked by your pawn." },
                                                  { san: "O-O", description: "Black played Nce7. Castle — no rush, Black's pieces are tangled and the d5 pawn cramps them." },
                                                  { san: "Nf6", description: "Black develops the other knight to f6." },
                                                  { san: "Re1", description: "Black played Nf6. Bring the rook to e1, piling onto the half-open e-file where Black's king still sits." },
                                                ),
                                              },
                                              {
                                                san: "Be7",
                                                ...
                                                variations: line(
                                                  ...
                                                  { san: "d4", description: "Black played Nf6. Now take the centre with d4 while your knight holds d5." },
                                                  { san: "Na5", description: "Black plays Na5, going after your bishop again." },
